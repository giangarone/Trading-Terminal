...
* **Venue tag icon** — The venue tag on order lines (entry, TP, SL, working close) now shows an `account_balance` icon matching the account selector in the topbar, styled to inherit the tag's `--info` color.
