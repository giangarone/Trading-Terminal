...
(function () {
  ...
  const SYMBOL_NAMES = {
    ...
    ICPUSD: 'Internet Computer', ETCUSD: 'Ethereum Classic', TONUSD: 'Toncoin',
    INJUSD: 'Injective', SEIUSD: 'Sei', TIAUSD: 'Celestia', RNDRUSD: 'Render',
    STXUSD: 'Stacks', IMXUSD: 'Immutable', GRTUSD: 'The Graph', AAVEUSD: 'Aave',
    MKRUSD: 'Maker', PEPEUSD: 'Pepe',
    ...
    ADBE: 'Adobe Inc.', PLTR: 'Palantir Technologies', COIN: 'Coinbase Global',
    MU: 'Micron Technology', QCOM: 'Qualcomm Inc.', SHOP: 'Shopify Inc.',
    UBER: 'Uber Technologies', ABNB: 'Airbnb, Inc.', BA: 'Boeing Co.', GS: 'Goldman Sachs',
    ...
    '6BU5': 'British Pound', '6EU5': 'Euro FX', '6JU5': 'Japanese Yen',
    LEU5: 'Live Cattle', HEU5: 'Lean Hogs', RBU5: 'RBOB Gasoline',
    ...
    EURNZD: 'Euro / NZ Dollar', GBPCHF: 'British Pound / Swiss Franc', CADJPY: 'Canadian Dollar / Japanese Yen',
    NZDJPY: 'NZ Dollar / Japanese Yen', USDSEK: 'US Dollar / Swedish Krona',
  };
